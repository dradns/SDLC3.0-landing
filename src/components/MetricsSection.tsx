          ...
          {metrics.map((metric, index) => (
            <Card key={index} className="relative p-8 bg-card/50 backdrop-blur-sm border border-primary/20 shadow-lg hover:shadow-xl hover:border-primary/40 transition-all duration-500 group text-center overflow-hidden">
              ...
              <div className="relative z-10">
                ...
                <div className="flex items-center justify-center h-10 bg-gradient-to-r from-success/10 to-success/20 text-success text-sm font-semibold px-6 rounded-full min-w-[160px] shadow-sm border border-success/20 mt-2">
                  {metric.improvement}
                </div>
              </div>
